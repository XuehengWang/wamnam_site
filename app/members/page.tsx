...
function MemberCard({ m }: { m: Member }) {
  return (
    <article className="rounded-[16px] bg-[#72426F] px-4 py-5 sm:px-6 sm:py-6 text-white">
      ...
      <div className="grid grid-cols-[110px_1fr] sm:grid-cols-[140px_1fr] md:grid-cols-[200px_1fr] items-start gap-4 sm:gap-5">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-4 sm:mt-5 space-y-[2px] text-[13px] sm:text-[14px] leading-[1.3] text-white/95">
